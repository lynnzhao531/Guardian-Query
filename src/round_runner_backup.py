...
import csv, hashlib, json, logging, math, random, time
...
DIMS = ["decision"] + MFULL
MODEL_KEYS = ["m1", "m2old", "m2new", "m3", "m4"]
...
def _score_article(title, body, m1, m2old, m2new, m3, m4, dry_run=False):
...
def run_round(round_id: int, *, dry_run: bool = False) -> dict:
    ...
    try:
        ...
        for art in scored_set:
            ...
            scores = _score_article(t, b, m1, m2old, m2new, m3, m4, dry_run=dry_run)
