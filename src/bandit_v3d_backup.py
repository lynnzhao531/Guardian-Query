...
# §5.2: 12 features (v3b: added method_saturation)
FEATURE_NAMES = [
    ...
    "method_saturation",    # 11: 1 - avg_unique_rate of last 3 rounds targeting this method
]
...
class Bandit:
    ...
    def __init__(self, rho: float = 0.92):  # v3b: 0.97→0.92 for faster adaptation
        self.rho = rho
        self.d = FEATURE_DIM
